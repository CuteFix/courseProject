 ...
 */
public class CityFindFrag extends Fragment {
    ...
    static CityFindFrag instance;

    public static CityFindFrag getInstance() {
        if (instance == null)
            instance = new CityFindFrag();
        return instance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView =  inflater.inflate(R.layout.fragment_city_find, container, false);
        ...
        compositeDisposable.add(mService.getWeatherByCity(cityName,
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_wind.setText(new StringBuilder("Скор: ").append(String.valueOf(weatherResult.getWind().getSpeed())).append(" м/c ").append("Напр: ").append(String.valueOf(weatherResult.getWind().getDeg())).append("°"));
